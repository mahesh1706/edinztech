...
export default function WorkshopDetails() {
    ...
    const tags = ["Hands-on", "Certificate", "Expert Instructor"];
    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 animate-in fade-in slide-in-from-bottom-5 duration-500 relative">
            ...
            <div className="lg:col-span-2 space-y-8">
                ...
                <Card>
                    <h3 className="text-xl font-bold text-secondary mb-4 border-b border-gray-100 pb-2">About this Workshop</h3>
